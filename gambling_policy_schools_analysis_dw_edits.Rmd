...
Data Point #1: "The Povich and Howard centers asked 145 Division I public universities in states where sports betting is legal to share their campus policies that address gambling."
Answer: See line 133.

Data Point #2: "Forty-five responded and the Povich and Howard centers reviewed 19 more policies that were posted on universities’ websites."
Answer: Line 134: "64 of those schools (44%) responded back to us. 42 schools mention sports betting (29%)."

Data Point #3: "In all, less than half of the 64 schools had published betting policies."
Answer: 
...
illegal <- c('Alabama', 'Alaska', 'California', 'Florida', 'Georgia', 'Hawaii', 'Idaho', 'Kentucky', 'Minnesota', 'Missouri', 'Oklahoma', 'South Carolina', 'Texas', 'Utah', 'Vermont')

legal <- c('Arizona','Arkansas','Colorado','Connecticut','Delaware','Illinois','Indiana','Iowa','Kansas','Louisiana','Maine','Maryland','Massachusetts','Michigan','Mississippi','Montana','Nebraska','Nevada','New Hampshire','New Jersey','New Mexico','New York','North Carolina','North Dakota','Ohio','Oregon','Pennsylvania','Rhode Island','South Dakota','Tennessee','Virginia','Washington','West Virginia','Wisconsin','Wyoming')

uni_policies_updated <- uni_policies_updated %>% 
  mutate(legal_illegal = case_when(
    state %in% illegal ~ 'illegal',
    state %in% legal ~ 'legal'
    )
  )
